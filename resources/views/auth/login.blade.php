            ...
            <div class="card-center mt-5 mx-3 px-4 py-4 bg-white rounded-m">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6">
                        <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
                            ...
                            <input type="number" required minlength="10" maxlength="10" class="form-control @error('mobile') is-invalid @enderror"  rounded-xs" id="mobile" name="mobile" placeholder="Enter Mobile">
                    ...
                    @enderror
                                        ...
                                        <div class="col-12 col-lg-6 col-md-6">
                                            <div class="form-custom form-label form-border form-icon mb-4 bg-transparent">
                                                ...
                                                <input type="password" required class="form-control rounded-xs @error('password') is-invalid @enderror"  id="password" name="password" placeholder="Enter Password">
                ...
                <div class="row">
                    <div class="col-6 text-start">
                        <a  class="font-11 color-theme  pt-4 d-block" href="{{url('password/reset')}}">Forgot Password?</a>
                    </div>
                    <div class="col-6 text-end">
                        <a href="{{route('register')}}" class="font-11 color-theme  pt-4 d-block"><span>Create Account</span></a>
                    </div>
                </div>
            </div>
