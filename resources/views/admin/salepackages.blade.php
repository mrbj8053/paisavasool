                                ...
                                <div class="col-xs-12 col-sm-12" style="width:100%;overflow-x:auto">
                                    <table id="basic-col-reorder" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="basic-col-reorder_info">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                @if($item->status==0)
                                                    <a href="javascript:void(0)" class="btn btn-warning" onclick="confirmRedirect('{{route('admin.salepackage.apply',Crypt::encrypt($item->id))}}')">Apply Now</a>
                                                    <a href="javascript:void(0)" class="btn btn-danger" onclick="confirmDelete('{{route('admin.salepackage.delete',Crypt::encrypt($item->id))}}')">Delete Request</a>
                                                @else
