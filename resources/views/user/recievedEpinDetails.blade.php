...
<div class="row">
    <div class="col-sm-12">
        <h5>Epins Recieved Detail</h5><br>
        <h3><b style="color:blue; font-size:21px;">Dashboard</b><i class="fa fa-arrow-right"></i><span style="font-size:18px;">&nbsp;Epins / Recieved E-Pins Detail</span></h3>
        <div class="card">
            <div class="card-header">
                <h5><i class="fa fa-table"></i>&nbsp; &nbsp; Recieved E-Pins</h5>
                                ...
                                <div class="col-xs-12 col-sm-12" >
                                    <table id="basic-col-reorder" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="basic-col-reorder_info">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                            @endphp
                                            @foreach(userhelper::getEpinRecievedHistory(Auth::user()->ownid) as $item)
                                       
                                            <tr role="row" class="odd textcenter">

                                            <td>{{++$i}}</td>
                                            <td>{{$item->count}}</td>
                                            <td>{{$item->fromuser."(".$item->name.")"}}</td>
