...
<div class="row">
    <div class="col-sm-12">
        <h5>Royalty Achivers</h5><br>
        <h3><b style="color:blue; font-size:21px;">Dashboard</b><i class="fa fa-arrow-right"></i><span style="font-size:18px;">&nbsp;Royalty Achivers</span></h3>
        <div class="card">
            <div class="card-header">
                <h5><i class="fa fa-table"></i>&nbsp; &nbsp;Royalty Achivers</h5>
