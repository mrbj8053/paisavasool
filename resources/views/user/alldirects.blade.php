...
<div class="row">
    <div class="col-sm-12">
        <h5>All Directs</h5><br>
        <h3><b style="color:blue; font-size:21px;">Dashboard</b> <i class="fa fa-arrow-right"></i><span style="font-size:18px;">&nbsp;Income/Active Directs</span></h3>
        <div class="card">
            <div class="card-header">
                <h5><i class="fa fa-table"></i>&nbsp; &nbsp;All Directs</h5>
