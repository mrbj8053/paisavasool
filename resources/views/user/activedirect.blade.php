    ...
    <div class="col-sm-12">
        <div class="card" style="padding: 9px;">
            <div class="card-header">
                <h5><i class="fa fa-table"></i>&nbsp; &nbsp;Active Directs</h5>
                ...
                <h3><b style="color:blue; font-size:21px;">Dashboard</b> <i class="fa fa-arrow-right"></i><span style="font-size:18px;">&nbsp;Income/Active Directs</h3>
            <div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12" >
                                    <table id="basic-col-reorder" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="basic-col-reorder_info">
                                       ...
                                       @php 
                                       $plan=userHelper::getPlanDetails($item->currentplan);
                                       $total+=$plan->entryamount;
                                       ...
                                       <tr role="row" class="odd textcenter">
                                        ...
                                        <td>{{$item->activeon?\Carbon\Carbon::parse($item->activeon)->format("d/m/Y"):""}}</td>
                                        </tr>
                                       @endforeach
                                    ...
                                    <h1>Total Direct Business is : {{$total}}</h1>
                                </div>
                            </div>
