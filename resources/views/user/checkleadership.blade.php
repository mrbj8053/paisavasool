...
<div class="row">
    <div class="col-sm-12">
        <h5>Leadership Directs</h5><br>
        <h3><b style="color:blue; font-size:21px;">Dashboard</b><i class="fa fa-arrow-right"></i><span style="font-size:18px;">&nbsp;Income/ Check Leadership Achivement</span></h3>

        <div class="card" style="padding: 9px;">
            <div class="card-header">
                <h5><i class="fa fa-table"></i>&nbsp; &nbsp;Leadership Directs</h5><br>
